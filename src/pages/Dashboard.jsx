    ...
    <>
      <div className="search-form">
        ...
        <div className="form-group d-flex gap-2">
          <input className="form-control" type="number" value={activeToken} onChange={(e) => setActiveToken(e.target.value)} placeholder="Search by Token..." autoComplete="off" />
          <input className="form-control" type="number" value={activeMobile} onChange={(e) => setActiveMobile(e.target.value)} placeholder="Search by mobile..." autoComplete="off" maxLength={10} />
